...
export default function OrderPizza(props) {
  ...
  useEffect(() => {
    if (
      secimler.length >= 4 &&
      secimler.length <= 10 &&
      validateName(document.getElementById("name-input").value) &&
      isSizeSelected &&
      isDoughSelected
    ) {
      setIsEnabled(true);
  ...
  useEffect(() => {
    ...
    const newTotalPrice = 85.5 + secimlerFiyat + 85.5 * (quantity - 1);
        ...
        <div className="order-section">
          ...
          <div className="order-options">
            <div className="order-options-size">
              ...
              <div className="radio-div">
                <input
                  ...
                  id="Kucuk"
                  name="boyut"
                  onChange={() => handleChangeSize("Küçük")}
                />
              ...
              <div className="radio-div">
                <input
                  ...
                  id="Orta"
                  name="boyut"
                  onChange={() => handleChangeSize("Orta")}
                />
              ...
              <div className="radio-div">
                <input
                  ...
                  id="Buyuk"
                  name="boyut"
                  onChange={() => handleChangeSize("Büyük")}
                />
            ...
            <div className="order-options-type">
              <h3 className="h3-aciklamalar h3-hamur">
              ...
              >
                ...
                <option value="İnce" className="boyut-sec">
                  İnce
                </option>
                <option value="Orta" className="boyut-sec">
                  Orta
                </option>
                <option value="Kalın" className="boyut-sec">
                  Kalın
                </option>
              </select>
            </div>
